            ...
            <Grid container spacing={3} justify="center">
                <Grid item component={Card} xs={12} sm={3} className={cx(styles.card, styles.infected)}>
                    <CardContent>
                        ...
                        <Typography variant="body2">Number of active cases of active covid-19</Typography>
                ...
                <Grid item component={Card}xs={12} sm={3} className={cx(styles.card, styles.deaths)}>
                    <CardContent>
                        ...
                        <Typography color="textSecondary">{ new Date(lastUpdate).toDateString()}</Typography>
                        <Typography variant="body2">Number of deats cases of active covid-19</Typography>
